...
#define MPI_LB_old             ((MPI_Datatype)0x4c000010)
#define MPI_UB_old             ((MPI_Datatype)0x4c000011)
/* ********************************************************************* */
...
//    MPI_Type_extent(oldtype, (MPI_Aint *) &extent);
  MPI_Type_get_true_extent(oldtype, &lb, &extent);
...
/* check if MPI_Aint is large enough for size of global array. 
  ...
  MPI_Type_create_resized (tmp1, disps[1], disps[2]-disps[1], newtype);
