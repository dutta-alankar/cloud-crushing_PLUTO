 ...
 *********************************************************************** */
{
  int      dir, ncopyL, ncopyR, edge_loc;
...
/* --------------------------------------------------------
  ...
  DIM_LOOP(dir){
    ...
    switch(dir){
      case IDIR: edge_loc = IBEG; break;
      case JDIR: edge_loc = JBEG; break;
      case KDIR: edge_loc = KBEG; break;
    }
    xbeg   = grid->xbeg_glob[dir]; 
    
    switch(dir){
      case IDIR: edge_loc = IEND; break;
      case JDIR: edge_loc = JEND; break;
      case KDIR: edge_loc = KEND; break;
    }
