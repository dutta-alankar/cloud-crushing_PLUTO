 ...
 *********************************************************************** */
{
  ...
  TOT_LOOP(k, j, i) {
    d->Vc[RHO][k][j][i] = 1.0e-03*mu*CONST_mp/UNIT_DENSITY; 
    d->Vc[PRS][k][j][i] = 1.0e-03*CONST_kB*T0/(UNIT_DENSITY*UNIT_VELOCITY*UNIT_VELOCITY);
    d->Vc[VX1][k][j][i] = 0.; 
  }
}
 ...
 *********************************************************************** */
{
  ...
  DOM_LOOP(k, j, i) {
    T = (d->Vc[PRS][k][j][i] / d->Vc[RHO][k][j][i]) * pow(UNIT_VELOCITY,2) * (mu * CONST_mp)/CONST_kB;
  }
